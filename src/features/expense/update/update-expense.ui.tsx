import { Route } from "@expense-app/routes/edit-expense.$id"
import { useEditExpense } from "./use-update-expense";
...
export function UpdateExpenseUi() {
    ...
    const { form, onSubmit, isLoading } = useEditExpense(data!);

    return (
        <div className="justify-items-center justify-self-center m-10">
            Hello "/edit-expense/{data?.id}"!
